    ...
    export default {
        ...
        methods: {
            ...
            getData() {
                ...
                this.$post_('auth-rule/auth_rule_list',{pid:this.form.pid},(res)=>{
                    // console.log(res);
            ...
            saveEdit() {
                ...
                this.$post_('auth-rule/add_auth_rule',this.form,(res)=>{
                    console.log(res);
                    if(res.code=='0'){
                        this.getData();
            ...
            // 确定删除
            deleteRow(){
                this.$post_('auth-rule/del_auth_rule',{id:this.id},(res)=>{
                    console.log(res);
                    if(res.code=='0'){
                        this.$message.success(res.msg);
                    }else{
