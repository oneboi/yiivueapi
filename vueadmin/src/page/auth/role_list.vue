    ...
    export default {
        ...
        methods: {
            ...
            getData() {
                ...
                this.$post_('role/role_list',{pid:this.form.pid},(res)=>{
                    console.log(res);
            ...
            saveEdit() {
                ...
                this.$post_('role/role_add',this.form,(res)=>{
                    if(res.code=='0'){
                        if(this.id<1){
            ...
            // 确定删除
            deleteRow(){
                this.$post_('role/role_del',{id:this.id},(res)=>{
                    console.log(res);
                    if(res.code=='0'){
                        this.$message.success(res.msg);
                    }else{
            ...
            roleAuth(row){
                ...
                this.$post_('role/role_auth_list',params,(res)=>{
                    console.log(res);
            ...
            editAuth() {
                ...
                // console.log(authIds);
                this.$post_('role/role_auth_edit',{auths:authIds,id:this.curRoleId},(res)=>{
                    console.log(res);
                    this.showAuth = false;
                    if(res.code=='0'){
                        this.$message.success(res.msg);
